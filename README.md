...
└─────────┬──────────┘
 ...
 │                        │
 ▼                        ▼
Restore Draft         Fetch Previous
from MongoDB          Official Submissions
 │                        │
 └────────┬───────────────┘
          ▼
┌────────────────────┐
...
└────────────────────┘
 ...
 └────┬────┘   └────┬─────┘
   ...
   └──────────┬────────────┘
      ...
      ┌───────┴────────┐
      ▼                ▼
 Runtime Error      Query Success
      │                │
      ▼                ▼
 Return Error      Compare Result
 to Frontend       with Expected Output
                           │
                   ┌───────┴────────┐
                   ▼                ▼
             Wrong Answer       Correct Answer
                   │                │
                   ▼                ▼
             Verdict Stored    Verdict Stored
             in MongoDB        in MongoDB
                   │                │
                   └──────┬─────────┘
                          ▼
               Refresh Submission Panel
```
